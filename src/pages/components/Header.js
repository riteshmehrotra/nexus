...
import { Menu, Icon, Divider, Container, Label, Dropdown } from 'semantic-ui-react';
...
const LoggedInMenu = ({ id }) => {
    ...
    return <Menu stackable inverted>
        ...
        <Link href="/spaces"><Menu.Item onClick={() => onClickMenu("Spaces", "spaces")} active={isActive("/lab", router.pathname)}><Icon color='blue' name='gg circle'></Icon>Spaces</Menu.Item></Link>
